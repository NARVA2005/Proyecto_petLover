...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="editProductForm" action="llenarCamposClientes.php" method="GET">
          <div class="mb-3">
            <label for="idProducto" class="form-label">Id del cliente</label>
            <input type="number" class="form-control" id="idCliente" aria-describedby="emailHelp" name="id" readonly>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="nombreProducto" class="form-label">Apellido</label>
            <input type="text" class="form-control" id="apellido" aria-describedby="emailHelp" name="apellido" >
          </div>
          <div class="mb-3">
            <label for="stockProducto" class="form-label">Correo</label>
            <input type="text" class="form-control" id="correo" aria-describedby="emailHelp" name="correo" >
          </div>
          <div class="mb-3">
            <label for="precioProducto" class="form-label">Contra</label>
            <input type="text" class="form-control" id="contra" aria-describedby="emailHelp" name="contra" >
          </div>
...
<script>
    ...
    $('.edit-product').click(function() {
        ...
        var nombre = $(this).closest('tr').find('td:eq(1)').text(); // Obtiene el nombre del producto de la segunda celda de la fila
        nombre = nombre.trim();
        var apellido = $(this).closest('tr').find('td:eq(2)').text().trim();
        var correo = $(this).closest('tr').find('td:eq(3)').text().trim();  // Obtiene el stock del producto de la tercera celda de la fila
        var contra = $(this).closest('tr').find('td:eq(4)').text().trim(); // Obtiene el precio del producto de la cuarta celda de la fila
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="../Modulos/opeRegistroDos.php" method="post" enctype="multipart/form-data">
      <div class="mb-3">
            <label for="identificacion" class="form-label">identificacion</label>
            <input type="number" class="form-control" id="idCliente" aria-describedby="emailHelp" name="identi" >
          </div>
          <div class="mb-3">
            <label for="nombreCliente" class="form-label">Nombre</label>
            <input type="text" class="form-control" id="nombreCliente" aria-describedby="emailHelp" name="nombres" >
          </div>
          <div class="mb-3">
            <label for="apellidoCliente" class="form-label">Apellido</label>
            <input type="text" class="form-control" id="apellidoCliente" aria-describedby="emailHelp" name="apellidos" >
          </div>
          <div class="mb-3">
            <label for="correoCliente" class="form-label">Correo</label>
            <input type="text" class="form-control" id="correoCliente" aria-describedby="emailHelp" name="correo" >
          </div>
          <div class="mb-3">
            <label for="contraCliente" class="form-label">Contraseña</label>
            <input type="password" class="form-control" id="contraCliente" aria-describedby="emailHelp" name="contra" >
          </div>
    
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal" id="Guardar">Guardar</button>
          </div>
        </form>
      </div>
    </div>
...
const btnI = document.getElementById("Guardar");
btnI.addEventListener("click", (e) => {
    let id = document.getElementById("idCliente").value;
    let nombres = document.getElementById("nombreCliente").value;
    let apellidos = document.getElementById("apellidoCliente").value;
    let correo = document.getElementById("correoCliente").value;
    let contra = document.getElementById("contraCliente").value;

    if ( nombres===""||id===""||apellidos===""||correo===""||contra==="") {
        e.preventDefault();
