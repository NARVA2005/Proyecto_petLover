...
$sql = "SELECT s.descripcion AS servicio, COUNT(*) AS veces_utilizado 
        FROM detalle_factura_cita dfc
        INNER JOIN servicio s ON dfc.id_servicio = s.id
        GROUP BY dfc.id_servicio";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $veces_utilizado[] = $row['veces_utilizado'];
    }
}
        ...
        var barChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: <?php echo json_encode($veces_utilizado); ?>,
