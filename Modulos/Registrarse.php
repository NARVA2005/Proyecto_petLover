...
<form id="formularioRegistro" action="./Controladores/opeRegistro.php" method="POST" class="mt-5">
  <section class="form-register">
    <span class="paw-print">&#128062;</span>
    <h4>Registro de clientes</h4>
    <input class="controls" type="number" name="identi" id="identi" placeholder="Identificacion del dueño">
    <input class="controls" type="text" name="nombres" id="nombres" placeholder="Nombre del dueño">
    <input class="controls" type="text" name="apellidos" id="apellidos" placeholder="Apellido del dueño">
    ...
    <input class="botons" type="submit" id="btnRegistro"value="Registrar usuario">
    <br>
    <br>
    <a href="registroMascota.php" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4">Registro de la mascota</a>

    <p class="existing-account"><a href="IniciarSesion.php">¿Ya tengo cuenta?</a></p>
  </section>
</form>
...
<script src="../assets/js/VerificacionesRegistroClientes.js"></script>
</body>
</html>