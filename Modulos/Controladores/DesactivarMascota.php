...
if (isset($_REQUEST['id'])) {
    ...
    $consulta = $mysql->efectuarConsulta("SELECT estado FROM petlover.mascota WHERE id = $id");
    ...
    if ($consulta->num_rows > 0) {
        ...
        $actualizacion = $mysql->efectuarConsulta("UPDATE petlover.mascota SET estado = '$nuevo_estado' WHERE id = $id");
