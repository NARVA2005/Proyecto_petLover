...
$mysql = new MYSQL();
$mysql->conectar();
$consulta = $mysql->efectuarConsulta("SELECT * FROM petlover.servicio where estado='inactivo'");
$mysql->desconectar();
...
<div class="row py-3 px-lg-5">
    ...
    <div class="container  pt-5 ">
        <div class="d-flex flex-column text-center mb-5 pt-5 ">
            ...
            <h1 class="display-4 m-0"><span class="text-primary">PetLover</span>Empleados</h1>
        </div>
...
const idProductoEstado = (id) => {
    ...
    swalWithBootstrapButtons.fire({
        title: "¿Estás seguro?",
        text: "Esta acción cambiará el estado del servicio.",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            ...
            fetch('../Modulos/Controladores/DesactivarServicio.php', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                ...
                if (data.success) {
                    swalWithBootstrapButtons.fire({
                        title: "Éxito",
                        text: "El estado del servicio se ha cambiado correctamente.",
                        icon: "success"
                    }).then(() => {
                        // Recargar la página
                        location.reload();
