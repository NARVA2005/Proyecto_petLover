...
// Consulta SQL para obtener los ingresos por fecha
$sql = "SELECT DATE(fecha) AS fecha, SUM(total) AS ingresos FROM factura_cita GROUP BY DATE(fecha)";
...
<div class="row py-3 px-lg-5">
    ...
    <h1>Ingresos de la Peluquería por Fecha</h1>
    <div>
