...
$mysql = new MYSQL();
$mysql->conectar();
$consulta = $mysql->efectuarConsulta("SELECT * FROM petlover.mascota");
$mysql->desconectar();
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Registro de mascota</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="editProductForm" action="./Controladores/llenarCamposEditar.php" method="GET">
          <div class="mb-3">
            <label for="idProducto" class="form-label">Id de la mascota</label>
...
<script>
    ...
    $('.edit-product').click(function() {
        ...
        var nombre = $(this).closest('tr').find('td:eq(1)').text().trim(); // Obtiene el nombre del producto de la segunda celda de la fila
...
<div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form id="editProductForm" action="DesactivarProducto.php" method="GET">
